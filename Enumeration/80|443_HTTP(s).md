...
```
gobuster -u http(s)://[IP Address / Hostname]/[file / folder] -w [wordlist location options below] –o [output file location] -a '[Standard Mozilla User Agent]' -e -k -l -s 200,204,301,302,307,401,403 -x txt,html,php,asp,aspx,jsp
```
